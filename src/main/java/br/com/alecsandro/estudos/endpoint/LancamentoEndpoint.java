...
public class LancamentoEndpoint {
    ...
    public ResponseEntity<?> findByFornecedorName(@PathVariable String name) {
        return new ResponseEntity<>(dao.findByFornecedorNameIgnoreCaseContaining(name), HttpStatus.OK);
    }
